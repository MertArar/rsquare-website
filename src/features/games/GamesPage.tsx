...
type GameCategory = "PC Games" | "Mobile Games";

type ActiveTab = "All" | GameCategory | "Publishing";
...
const tabs: ActiveTab[] = ["All", "PC Games", "Mobile Games", "Publishing"];
          ...
          <div className="relative flex w-full max-w-[720px] items-center justify-between border-y border-white/10 py-3">
            {tabs.map((tab) => (
              <button
                ...
                className={`relative flex-1 cursor-pointer px-4 py-4 text-center text-[11px] sm:text-[12px] font-semibold uppercase tracking-[0.22em] transition-colors duration-300 ${
                  activeTab === tab
                    ? "text-white"
